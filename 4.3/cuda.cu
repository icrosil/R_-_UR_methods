 ...
 */
 ...
 __global__ void mykernel (double *rightSide, double wOpt, double *fa, double *diff, int n, double *all) {
...
int main(){
  ...
  */
  ...
  mykernel<<<N - 2, N - 2>>>(d_rs, wOpt, d_fa, d_diff, N * N - 4 * N + 4, d_all);
